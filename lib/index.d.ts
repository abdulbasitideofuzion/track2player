...
declare function setupPlayerOne(options?: PlayerOptions): Promise<void>;
...
declare function registerPlaybackServiceOne(factory: () => ServiceHandler): void;
...
declare function addOne(tracks: Track | Track[], insertBeforeIndex?: number): Promise<void>;
...
declare function playOne(): Promise<void>;
declare function pause(): Promise<void>;
declare function pauseOne(): Promise<void>;
...
declare const _default: {
    ...
    setupPlayerOne: typeof setupPlayerOne;
    destroy: typeof destroy;
    registerPlaybackService: typeof registerPlaybackService;
    registerPlaybackServiceOne: typeof registerPlaybackServiceOne;
    ...
    reset: typeof reset;
    play: typeof play;
    playOne: typeof playOne;
    pause: typeof pause;
    pauseOne: typeof pauseOne;
    stop: typeof stop;
